...
download. Accepted files are stored under a deterministic temporary work path
and create a typed `probe_asset` job, which is the hand-off into the media
pipeline; normalization and publication remain later orchestration work.
